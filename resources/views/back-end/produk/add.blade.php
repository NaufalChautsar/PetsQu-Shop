        ...
        <main class="flex-1 pb-8 pt-40 lg:pt-0">
            ...
            <!-- Header -->
                <div class="flex items-center justify-between gap-x-4 py-7 px-6 lg:px-12 lg:gap-x-0 xl:px-14">
                    <div>
                        <h1 class="text-2xl font-bold leading-relaxed text-gray-800">Tambah Produk</h1>
                            ...
                            <form action="{{ route('produks.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="md:flex md:gap-x-10">
                                    <div class="form-control w-full">
                                        ...
                                        <input type="text" name="nama_barang" placeholder="Royal Canin" class="input input-bordered w-full bg-white border-gray-300 focus:border-none focus:ring-2 focus:ring-primary placeholder:text-dark placeholder:text-sm placeholder:opacity-50" value="{{ old('nama_barang') }}" />
                                        @error('nama_barang')
                                            <label class="label">
                                    ...
                                    <div class="form-control w-full">
                                        ...
                                        <input type="text" name="stock" placeholder="0" class="input input-bordered w-full bg-white border-gray-300 focus:border-none focus:ring-2 focus:ring-primary placeholder:text-dark placeholder:text-sm placeholder:opacity-50" value="{{ old('stock') }}" />
                                        @error('stock')
                                            <label class="label">
                                                <span class="label-text-alt text-red-500 flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                <div class="md:flex md:gap-x-10">
                                    ...
                                    <div class="form-control w-full">
                                        ...
                                        <input type="text" name="harga" placeholder="15.000" class="input input-bordered w-full bg-white border-gray-300 focus:border-none focus:ring-2 focus:ring-primary placeholder:text-dark placeholder:text-sm placeholder:opacity-50" value="{{ old('harga') }}" />
                                        @error('harga')
                                            <label class="label">
                                                <span class="label-text-alt text-red-500 flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    <div class="w-full px-0">
                                        <div class="relative group w-full h-48 flex items-center justify-center">
                                            <div aria-hidden="true" class="absolute w-full h-full rounded-xl border border-gray-300 bg-white shadow-3xl group-hover:bg-gray-200 group-hover:bg-opacity-60 transition group-hover:border-none">
                                                <input type="file" name="foto" class="relative z-10 opacity-0 w-full h-full cursor-pointer" value="{{ old('foto') }}" multiple>
                                ...
                                <div class="form-control w-full">
                                    ...
                                    <textarea name="keterangan" class="textarea textarea-bordered h-32 w-full bg-white border-gray-300 focus:border-none focus:ring-2 focus:ring-primary placeholder:text-dark placeholder:text-sm placeholder:opacity-50" placeholder="Lorem ipsum dolor sit amet.">{{ old('keterangan') }}</textarea>
                                    @error('keterangan')
                                        <label class="label">
                                            <span class="label-text-alt text-red-500 flex">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
